...
ReactDOM.render(<div style={style_1}><HelloMessage name="John"/></div>, document.getElementById("test"));
ReactDOM.render(<div style={style_1}><HelloMessage /></div>, document.getElementById("test1"));
